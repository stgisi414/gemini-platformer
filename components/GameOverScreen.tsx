...
const GameOverScreen: React.FC<GameOverScreenProps> = ({ score, onRestart }) => {
  return (
    <div className="z-20 flex flex-col items-center justify-center text-center p-8 bg-black bg-opacity-60 rounded-xl shadow-2xl">
      ...
      <button
        onClick={onRestart}
        className="px-8 py-4 bg-blue-500 text-white text-2xl rounded-lg hover:bg-blue-600 active:bg-blue-700 transform hover:scale-110 transition-all duration-200 shadow-lg"
      >
        Try Again
      </button>
    </div>
