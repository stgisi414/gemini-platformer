...
const StartScreen: React.FC<StartScreenProps> = ({ onStart, error }) => {
  return (
    <div className="z-20 flex flex-col items-center justify-center text-center p-8 bg-black bg-opacity-60 rounded-xl shadow-2xl">
      ...
      <button
        onClick={onStart}
        className="px-8 py-4 bg-green-500 text-white text-2xl rounded-lg hover:bg-green-600 active:bg-green-700 transform hover:scale-110 transition-all duration-200 shadow-lg"
      >
        Start Game
      </button>
